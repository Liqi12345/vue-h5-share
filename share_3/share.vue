        ...
        <main class="test test-1 " :class="togclass">
            ...
            <div class="q_app">
                <div class="bdsharebuttonbox">
					...
					<img src="../../../assets/images/weixin_friend.png" style="width: 0.82rem;height: 1.18rem;float:left;margin-right:0.4rem" @click="show()">微信
                    ...
                    <div id="share_box">
                        <div class="social-share"  data-initialized="true" style="text-align: center;" data-url="http://www.bodesports.com/shareerweima.html"  data-title="2018啵嘚一夏，千人足球赛激战正酣。">
                            <a href="http://service.weibo.com/share/share.php" class="social-share-icon icon-weibo">
                            	<img src="../../../assets/images/weibo.png" style="width: 0.82rem;height: 1.18rem;">
                            </a>
                            <a href="http://connect.qq.com/widget/shareqq/index.html" class="social-share-icon icon-qq">
                            	<img src="../../../assets/images/QQ.png" style="width: 0.82rem;height: 1.18rem;">
                            </a>
                            <a href="http://sns.qzone.qq.com/cgi-bin/qzshare/cgi_qzshare_onekey"  class="social-share-icon icon-qzone qzj">
                            	<img src="../../../assets/images/qqzone.png" style="width: 0.82rem;height: 1.18rem;">空间
                            </a>
                        </div>
                    </div>
                </div>
